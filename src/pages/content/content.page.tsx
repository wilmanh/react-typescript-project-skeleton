...
import Content from "../../components/UI/Content/content.component";

interface ComponentProps {
  someProps: boolean;
}
const ContentPage: React.FC<ComponentProps> = (props: ComponentProps) => {
  return (
    <section className="section">
      <div className="container">
        <h1 className="title">Content example</h1>
...
export default withPublicArea(ContentPage);
