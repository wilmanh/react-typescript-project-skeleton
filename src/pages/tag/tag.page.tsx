...
const TagPage: React.FC<ComponentProps> = (props: ComponentProps) => {
  const { t } = props;
  ...
  return (
    <section className="section">
      <div className="container">
        ...
        <h2 className="subtitle">Small tag labels to insert anywhere</h2>
...
export default withPublicArea(TagPage);
